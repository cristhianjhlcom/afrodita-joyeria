                        ...
                        <div class="flex items-center justify-between gap-2">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    class="inline-flex min-h-9 items-center rounded-sm border border-rose-300 px-2 text-xs font-semibold text-rose-700 transition hover:bg-rose-50 dark:border-rose-700 dark:text-rose-300 dark:hover:bg-rose-900/20"
                                >
                                    {{ __('Remove') }}
                                </button>
                            </div>
